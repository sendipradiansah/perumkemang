        ...
        <div class="col-12">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Edit Isi Video</h3>
                </div>
                <!-- /.card-header -->
                <form action="<?php echo base_url();?>paneladmin/video/update/<?php echo $video['id']; ?>" method="POST">
                    <div class="card-body">
                        <div class="form-group">
                            <label for="content">Masukkan Isi</label>
                                <textarea name="content" id="content" cols="30" rows="10"><?= $video['video']?></textarea> 
                        </div>
                        <!-- /.card-body -->
                    </div>
